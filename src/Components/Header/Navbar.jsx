...
const Navbar = () => {
    ...
    const navlinks=<div className='flex flex-col lg:flex-row gap-3 text-lg'>
        ...
        <NavLink className={({isPanding, isActive})=> isPanding ? 'pending': isActive? 'active font-bold  text-red-600 ': 'bg-gradient-to-br from-indigo-700 to-green-500 text-transparent bg-clip-text font-bold'} to={'/register'}>Sign Up</NavLink>
    </div>
    return (
        <div className='sticky top-0 drop-shadow-xl z-50 bg-sky-200'>
            <div className="navbar ">
                ...
                <NavLink ><img src="https://i.ibb.co/bv5b4GR/6a1356dba4b00c62564c752314481f97-removebg.png" alt="" className='w-14' /></NavLink>
                </div>
