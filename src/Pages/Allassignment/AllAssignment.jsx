...
const AllAssignment = () => {
    ...
    // useEffect(()=>{
    //     axios.get('https://online-group-study-server-rho.vercel.app/assignmentCount', {withCredentials:true})
    //     .then(res=>{
    ...
    // useEffect(()=>{
    //     axios.get('https://online-group-study-server-rho.vercel.app/allassignments', {withCredentials:true})
    //     .then(res=>{
    //         // console.log(res.data);
    ...
    useEffect(()=>{
        axios.get(`https://online-group-study-server-rho.vercel.app/allassignments?page=${currentPage}&size=${itemsPerPage}&level=${selectedDifficulty}`, { withCredentials: true })
